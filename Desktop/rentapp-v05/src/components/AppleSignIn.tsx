...
export default function AppleSignIn({
  ...
  const variantClasses = {
    default: 'bg-black border border-gray-300 text-white',
    compact: 'bg-gray-900 border border-gray-600 text-white',
    outline: 'bg-transparent border-2 border-gray-300 text-black'
  }
